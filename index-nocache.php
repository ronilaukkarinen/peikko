      ...
      <div class="row">
        ...
        <div class="esittely">
          ...
          <div class="powered-by">
            ...
            <div class="cols">
              <div class="col">
                <a href="https://www.telia.fi" class="telia"><?php echo file_get_contents('svg/telia.svg'); ?></a>
              </div>
              <div class="col">
                <a href="https://www.ui.com"><?php echo file_get_contents('svg/ubiquiti.svg'); ?></a>
              </div>
            </div>
          </div>
...
<div class="tapahtumat">
  ...
  <div id="np" class="event" style="display:none;">
    <?php include('src/lastfm.php'); ?>
  </div>

  <div id="trakt" class="event" style="display:none;">
    <?php include('src/trakt.php'); ?>
  </div>

  <div id="irc" class="event" style="display:none;"><blockquote><?php
...
<!-- New terminal -->
<div class="browser-window" style="display: none;">
